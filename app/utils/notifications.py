...
def send_whatsapp_notification(message, phone_number=None):
    ...
    try:
        ...
        # Programar el mensaje para que se envíe un minuto después
        send_hour = now.hour
        ...
        wait_time = 20  # Esperar 20 segundos para que cargue WhatsApp
        
        # Utilizar el método programado que normalmente presiona enviar automáticamente
